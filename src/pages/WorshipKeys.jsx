...
<section className="py-28 px-6 bg-[#0B0F14]">
  <div className="max-w-6xl mx-auto">
    ...
    <p className="text-center text-sm text-[#B8C1CC] mt-6">
  Most students see visible improvement in confidence, clarity, and
  worship playing within the <strong>first 3–4 weeks</strong> of joining.
</p>
